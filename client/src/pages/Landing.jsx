    ...
    <div className="min-h-screen bg-white overflow-hidden">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center mb-20">
          <h2 className={`text-5xl sm:text-6xl font-bold text-gray-900 mb-6 leading-tight transition-all duration-1000 ${
            isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
          }`}>
            Smart Inventory<br />Management System
          </h2>
          
          <p className={`text-xl text-gray-600 mb-10 max-w-3xl mx-auto leading-relaxed transition-all duration-1000 delay-200 ${
            isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
          }`}>
          ...
          <div className={`flex flex-col sm:flex-row gap-4 justify-center items-center transition-all duration-1000 delay-300 ${
            ...
            <a 
              href="/signup" 
              className="px-8 py-3 bg-gray-900 text-white font-medium rounded-lg hover:bg-gray-800 hover:shadow-lg transition-all duration-300 hover:scale-105"
            >
              Get Started Free
            </a>
            <a 
              href="/login" 
              className="px-8 py-3 bg-gray-200 text-gray-900 font-medium rounded-lg hover:bg-gray-300 transition-all duration-300 hover:shadow-lg"
            >
              Sign In
            </a>
          </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {[0, 1, 2, 3, 4, 5].map((index) => (
            <div 
              key={index}
              className={`p-6 border border-gray-200 rounded-lg hover:border-gray-400 hover:shadow-lg hover:-translate-y-2 transition-all duration-500 ${
                isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
              }`}
              style={{
            ...
            >
              {index === 0 && <Package className="w-8 h-8 text-gray-900 mb-4" />}
              {index === 1 && <BarChart3 className="w-8 h-8 text-gray-900 mb-4" />}
              {index === 2 && <Users className="w-8 h-8 text-gray-900 mb-4" />}
              {index === 3 && <AlertCircle className="w-8 h-8 text-gray-900 mb-4" />}
              {index === 4 && <Package className="w-8 h-8 text-gray-900 mb-4" />}
              {index === 5 && <Lock className="w-8 h-8 text-gray-900 mb-4" />}
      ...
      {/* CTA Section */}
      <section className={`bg-gray-900 text-white py-16 transition-all duration-1000 ${
        isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
      }`}
      style={{
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <a 
            href="/signup" 
            className="inline-block px-8 py-3 bg-white text-gray-900 font-medium rounded-lg hover:bg-gray-100 transition-all duration-300 hover:shadow-lg hover:scale-105"
          >
